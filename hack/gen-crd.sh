...
function annotate_capacitybuffer_crd() {
  script1='/^  annotations:/a\
...
go run ./vendor/sigs.k8s.io/controller-tools/cmd/controller-gen crd:crdVersions=v1 paths=./vendor/k8s.io/autoscaler/cluster-autoscaler/apis/capacitybuffer/autoscaling.x-k8s.io/v1alpha1/...
...
annotate_capacitybuffer_crd config/crd/autoscaling.x-k8s.io_capacitybuffers.yaml install/12_capacitybuffer.crd.yaml
rm -rf ./config/crd
